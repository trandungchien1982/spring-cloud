...
public class FunctionComp {
	...
	/**
	 * Nhận message Teacher từ Kafka trong topic `start-kafka-topic`
	 * và biến đổi data thành Teacher2
	...
	public Function<Teacher, Teacher2> functionConvertTeacher2() {
		return teacher ->
		{
			log.info("functionConvertTeacher2 in App4+Kafka02: Create Teacher2 from Teacher: " + teacher);
